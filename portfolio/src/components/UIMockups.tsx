          ...
          <motion.div key={mockup.title} variants={itemVariants}>
            <BentoCard hover className="h-full group">
              <div className="flex flex-col h-full">
                ...
                {/* Links */}
                <div className="flex items-center gap-4 pt-4 border-t border-[rgba(0,0,0,0.09)]">
                  <a
                    href={mockup.liveUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-sm font-medium text-[#888] hover:text-gray-900 transition-colors"
                  >
