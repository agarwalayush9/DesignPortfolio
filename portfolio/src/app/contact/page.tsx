            ...
            <BentoCard hover>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  <motion.label
                    className="absolute left-0 text-[12px] font-mono tracking-wider text-[#404040] transition-all pointer-events-none"
                    animate={{
                      y: focused === 'name' ? -8 : 8,
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b border-[rgba(255,255,255,0.06)] focus:border-[#22c55e] text-white text-[14px] py-3 pt-6 outline-none transition-colors duration-300"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onBlur={(e) => !e.target.value && setFocused(null)}
                    className="w-full bg-transparent border-b border-[rgba(255,255,255,0.06)] focus:border-[#22c55e] text-white text-[14px] py-3 pt-6 outline-none transition-colors duration-300 resize-none"
                  />
                </div>
          ...
          >
            <BentoCard hover delay={0.2}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[13px] font-semibold text-white mb-1">Email</h3>
                  <p className="text-[12px] text-[#525252] font-mono">hello@ayush.dev</p>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard hover delay={0.3}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[13px] font-semibold text-white mb-1">Location</h3>
                  <p className="text-[12px] text-[#525252] font-mono">India · IST (UTC+5:30)</p>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard hover delay={0.4}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[13px] font-semibold text-white mb-1">Availability</h3>
                  <p className="text-[12px] text-[#525252] font-mono">Open for freelance & full-time</p>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard hover delay={0.5}>
              ...
              >
                <div>
                  <h3 className="text-[13px] font-semibold text-white mb-1">Book a 30-min call</h3>
                  <p className="text-[12px] text-[#525252] font-mono">Via Cal.com</p>
                </div>
