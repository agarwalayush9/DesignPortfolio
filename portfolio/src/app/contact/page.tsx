    ...
    <PageTransition>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-24 pb-20">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="section-label mb-4 text-sm">CONTACT</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b border-[rgba(0,0,0,0.09)] focus:border-[#22c55e] text-gray-900 text-base py-3 pt-6 outline-none transition-colors duration-300"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onBlur={(e) => !e.target.value && setFocused(null)}
                    className="w-full bg-transparent border-b border-[rgba(0,0,0,0.09)] focus:border-[#22c55e] text-gray-900 text-base py-3 pt-6 outline-none transition-colors duration-300 resize-none"
                  />
                </div>
            ...
            <BentoCard hover delay={0.2}>
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-gray-600 font-mono truncate" title="ayushagarwal.contact@gmail.com">ayushagarwal.contact@gmail.com</p>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard hover delay={0.3}>
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-gray-600 font-mono truncate" title="India · IST (UTC+5:30)">India · IST (UTC+5:30)</p>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard hover delay={0.4}>
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-gray-600 font-mono truncate" title="Open for freelance & full-time">Open for freelance & full-time</p>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard hover delay={0.5}>
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-gray-600 font-mono truncate">Via Cal.com</p>
                </div>
